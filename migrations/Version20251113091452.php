 ...
 */
final class Version20251113091452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE juego_nds ADD biblioteca_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE juego_nds DROP biblioteca_id');
    }
}
